...
| Invested |  |  |  |  |  |  |  |
| $\$ 1 \mathrm{~K}$ | $\$ 5 \mathrm{~K}$ |  | $\$ 2 \mathrm{~K}$ | $\$ 6 \mathrm{~K}$ |  | $\$ 1 \mathrm{~K}$ | $\$ 2 \mathrm{~K}$ |
| $\$ 2 \mathrm{~K}$ | $\$ 8 \mathrm{~K}$ |  | $\$ 3 \mathrm{~K}$ | $\$ 8 \mathrm{~K}$ |  | $\$ 2 \mathrm{~K}$ | $\$ 3 \mathrm{~K}$ |
| $\$ 3 \mathrm{~K}$ | $\$ 10 \mathrm{~K}$ |  | $\$ 4 \mathrm{~K}$ | $\$ 9 \mathrm{~K}$ |  |  |  |
...
| :---: | :---: | :---: |
| Number of Teams <br> Allocated | Collecting and <br> Compression Project | Cataloging and <br> Storage Project |
| 1 | 5 | 4 |
| 2 | 9 | 10 |
| 3 | 12 | 15 |
